...
class LoginPageController {
  ...
  void goToHomepage() async {
    ...
    try {
      ...
      print("NORMAL SIGNIN GETSONG EMPTY, CREATING EMPTY SONGMODEL");
      songlist = <SongModel>[];
  ...
  void saveEmail(String newValue) {
    ...
    state.user.email =
        newValue.replaceAll(String.fromCharCode(newValue.length - 1), '');
  }
  ...
  Future<String> signInWithGoogle() async {
    ...
    try {
      ...
      try {
        ...
        print("GOOGLE SIGNIN GETSONG EMPTY, CREATING EMPTY SONGMODEL");
        songlist = <SongModel>[];
        print("SONGLiST LENGTH: " + songlist.length.toString());
      }
      if (matchedUID == true) {
        ...
        state.user.username =
            substring; //Set username as Google acount trimmed until '@'
      ...
      if (state.biometricList.length < 1) {
        ...
        if (state.readInData == null) {
          ...
          try {
            ...
            print("BIOMETRIC SIGNIN GETSONG EMPTY, CREATING EMPTY SONGMODEL");
            songlist = <SongModel>[];
            print("SONGLiST LENGTH: " + songlist.length.toString());
          }
